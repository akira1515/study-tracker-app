...
class StudyRecordsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('study_records')->insert([
            ...
            ['date' => '2023-02-02', 'hour' => 6],
            ['date' => '2023-02-03', 'hour' => 1],
            ['date' => '2023-02-04', 'hour' => 3],
            ['date' => '2023-02-05', 'hour' => 1],
            ['date' => '2023-02-06', 'hour' => 2],
            ['date' => '2023-02-07', 'hour' => 4],
            ['date' => '2023-02-08', 'hour' => 3],
            ['date' => '2023-02-09', 'hour' => 9],
            ['date' => '2023-02-10', 'hour' => 4],
            ['date' => '2023-02-11', 'hour' => 7],
            ['date' => '2023-02-12', 'hour' => 4],
            ['date' => '2023-02-13', 'hour' => 4],
            ['date' => '2023-02-14', 'hour' => 4],
            ['date' => '2023-02-16', 'hour' => 4],
            ['date' => '2023-02-17', 'hour' => 0],
            ['date' => '2023-02-18', 'hour' => 10],
            ['date' => '2023-02-19', 'hour' => 2],
            ['date' => '2023-02-20', 'hour' => 1],
            ['date' => '2023-02-21', 'hour' => 2],
            ['date' => '2023-02-22', 'hour' => 3],
            ['date' => '2023-02-23', 'hour' => 6],
            ['date' => '2023-02-24', 'hour' => 4],
            ['date' => '2023-02-25', 'hour' => 3],
            ['date' => '2023-02-26', 'hour' => 1],
            ['date' => '2023-02-28', 'hour' => 6],
